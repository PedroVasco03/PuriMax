<?php
      ...
      if(isset($_POST['btn_env'])){
            ...
            $insert_sms = mysqli_query($con,"INSERT INTO tb_sms(id_usu,sms,data_now,hora,env_por,imagem) VALUES($id_usu,'$mensagem','$data','$hora','$email','$img')");
    
            header("location:http://localhost/PuriMax/chat_cli.php?id=$id_user_sms");
            ...
            <div class="card-body">
              <div class="card">
                ...
                <form action="" method="POST" enctype="multipart/form-data">
                    <?php
                        $select_sms = mysqli_query($con,"SELECT *FROM tb_sms WHERE id_usu=$id_usu ORDER by id_sms");
